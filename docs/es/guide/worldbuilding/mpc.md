...
<ZoomImage src="/img/guide/worldbuilding/mpc_switch.png" alt="Interruptor de Escaneo Automático del MPC" />

</div>
<div style="flex: 1; min-width: 300px;">

Mientras redacta en el **[editor](../editor/basics.md)**, el motor de IA analiza el flujo de su narrativa de forma periódica y silenciosa en segundo plano para detectar elementos clave que aún no han sido registrados (Personajes, Lugares, Objetos o elementos de Lore).
...
**Para que el análisis en segundo plano se ejecute, asegúrese de tener activado el interruptor "Scanning Auto" en la cabecera de la vista del **[Compendio](./compendium.md)**.**
...
- **Aceptar**: La entidad se crea en el **[Compendio](./compendium.md)**. El sistema intenta extraer automáticamente datos como el rol, la categoría o rasgos distintivos basándose en el contexto.
...
## Siguiente paso
Aprenda a profundizar en los vínculos entre sus descubrimientos en **[Relaciones y Entidades](./entities.md)**.
