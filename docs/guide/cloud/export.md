...
1. Expand the Project menu (with your work's name) in the sidebar.
2. Select **Export Projects (.lwrt)** for a complete project backup (Lore and Manuscript) or **Export Manuscript (.docx)** to export the novel's text.
3. The file will be automatically downloaded to your computer.

<ZoomImage src="/img/guide/cloud/export_options.png" alt="Export options in the project menu" />
