...
<ZoomImage src="/img/guide/cloud/cloud_sync_setup.png" alt="Google Drive Sync Configuration" />


## How Synchronization Works
Once activated, the application will manage your files as follows:

- **Background Saving**: When making major changes, LoneWriter will attempt to synchronize the local version with the cloud copy, including the **[Compendium](../worldbuilding/compendium.md)**, the Manuscript, and **[Nexus](../analysis/nexus.md)** data.
...
<ZoomImage src="/img/guide/cloud/cloud_restore.png" alt="Cloud version available indicator" />
