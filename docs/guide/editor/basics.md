...
2. **Metadata and Nexus**: From this section, you can change the scene status (**Draft, In Progress, Completed**), assign the **POV** (Point of View), and set the date and synopsis. This data is essential for the Nexus chronological visualizations.
...
### Assistance Tools
1. **[Oracle](../analysis/oracle.md)**: Your direct connection to the world's knowledge. It allows you to query the lore, characters, or plots you have defined in your project.
2. **[MPC](../worldbuilding/mpc.md)**: The Compendium Proposal Monitor analyzes your text to suggest new entries or updates for your personal encyclopedia.
